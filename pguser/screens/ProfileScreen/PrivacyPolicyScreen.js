  ...
  return (
    <ScrollView style={{backgroundColor: 'white', flex: 1, padding: 12}}>
      ...
      <Text
        ...
        the use of ShelterHub's App, located at https://www.shelterhub.com/.{' '}
        {'\n'}
        {'\n'}By accessing this app we assume you accept these terms and
        conditions. Do not continue to use shelterhub.com if you do not agree to
        take all of the terms and conditions stated on this page. {'\n'}
        {'\n'}The following terminology applies to these Terms and Conditions,
        Privacy Statement and Disclaimer Notice and all Agreements: "Client",
        "You" and "Your" refers to you, the person log on this app and compliant
        to the Company’s terms and conditions. "The Company", "Ourselves", "We",
        ...
        shelterhub.com, you agreed to use cookies in agreement with the
        ShelterHub's Privacy Policy. Most interactive apps use cookies to let us
        retrieve the user’s details for each visit. Cookies are used by our app
        to enable the functionality of certain areas to make it easier for
        people visiting our app. Some of our affiliate/advertising partners may
        also use cookies.
        {'\n'}
        {'\n'}
        License {'\n'}Unless otherwise stated, ShelterHub and/or its licensors
        own the intellectual property rights for all material on shelterhub.com.
        All intellectual property rights are reserved. You may access this from
        shelterhub.com for your own personal use subjected to restrictions set
        in these terms and conditions.{'\n'}
        {'\n'} You must not:{'\n'}
        {'\n'} Republish material from shelterhub.com{'\n'} Sell, rent or
        ...
        opinions and information in certain areas of the app. ShelterHub does
        not filter, edit, publish or review Comments prior to their presence on
        the app. Comments do not reflect the views and opinions of
        ShelterHub,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, ShelterHub shall not be liable for the
        ...
        of the Comments on this app.{'\n'}
        {'\n'} ShelterHub reserves the right to monitor all Comments and to
        ...
        Comments on our app and have all necessary licenses and consents to do
        ...
        activity.{'\n'} You hereby grant ShelterHub a non-exclusive license to
        ...
        to our App without prior written approval: Government agencies;{'\n'}
        {'\n'} Search engines;{'\n'}
        {'\n'} News organizations;{'\n'}
        {'\n'} Online directory distributors may link to our App in the same
        manner as they hyperlink to the Apps of other listed businesses; and
        System wide Accredited Businesses except soliciting non-profit
        organizations, charity shopping malls, and charity fundraising groups
        which may not hyperlink to our Web site. These organizations may link to
        our home page, to publications or to other App information so long as
        the link:{'\n'}
        ...
        linking party’s site. We may consider and approve other link requests
        ...
        and educational institutions and trade associations. We will approve
        link requests from these organizations if we decide that:{'\n'}
        {'\n'} (a) the link would not make us look unfavorably to ourselves or
        to our accredited businesses; {'\n'}(b) the organization does not have
        any negative records with us;{'\n'} (c) the benefit to us from the
        visibility of the hyperlink compensates the absence of ShelterHub; and
        {'\n'} (d) the link is in the context of general resource information.
        These organizations may link to our home page so long as the link:{'\n'}
        {'\n'} (a) is not in any way deceptive;{'\n'} (b) does not falsely imply
        sponsorship, endorsement or approval of the linking party and its
        products or services; and{'\n'} (c) fits within the context of the
        linking party’s site. If you are one of the organizations listed in
        paragraph 2 above and are interested in linking to our app, you must
        inform us by sending an e-mail to ShelterHub. Please include your name,
        your organization name, contact information as well as the URL of your
        site, a list of any URLs from which you intend to link to our App, and a
        list of the URLs on our site to which you would like to link. Wait 2-3
        weeks for a response. Approved organizations may hyperlink to our App as
        follows: By use of our corporate name; or By use of the uniform resource
        locator being linked to; or By use of any other description of our App
        being linked to that makes sense within the context and format of
        content on the linking party’s site. No use of ShelterHub's logo or
        ...
        may not create frames around our Webpages that alter in any way the
        visual presentation or appearance of our App. Content Liability We shall
        not be hold responsible for any content that appears on your App. You
        agree to protect and defend us against all claims that is rising on your
        App. No link(s) should appear on any App that may be interpreted as
        ...
        rights. Your Privacy Please read Privacy Policy Reservation of Rights We
        reserve the right to request that you remove all links or any particular
        link to our App. You approve to immediately remove all links to our App
        upon request. We also reserve the right to amen these terms and
        conditions and it’s linking policy at any time. By continuously linking
        to our App, you agree to be bound to and follow these linking terms and
        conditions. Removal of links from our app If you find any link on our
        App that is offensive for any reason, you are free to contact and inform
        us any moment. We will consider requests to remove links but we are not
        obligated to or so or to respond to you directly. We do not ensure that
        the information on this app is correct, we do not warrant its
        completeness or accuracy; nor do we promise to ensure that the app
        ...
        all representations, warranties and conditions relating to our app and
        the use of this app. Nothing in this disclaimer will: limit or exclude
        ...
        be excluded under applicable law. The limitations and prohibitions of
        liability set in this Section and elsewhere in this disclaimer: (a) are
        ...
        in tort and for breach of statutory duty. As long as the app and the
        information and services on the app are provided free of charge, we will
